...
GIT_REPO_URL="https://github.com/ajmalhmir/database_1.git"
...
# Execute scripts for OS dependencies, Python dependencies, Gunicorn, Nginx, starting the application, and creating superuser
